...
export default function MyToolsTable() {
    ...
    const loadTools = async () => {
      ...
      try {
        ...
        await Swal.fire({
          icon: "error",
          title: "Error",
          text: "Failed to fetch your tools.",
        });
  ...
  async function handleDelete(id: string) {
    ...
    const result = await Swal.fire({
      ...
      text: "You won't be able to recover this tool!",
                ...
                >
                  ...
                  <td className="p-4 text-center">
                    ...
                    <a
                      ...
                      className="inline-flex items-center rounded-lg px-3 py-2 text-sm font-medium text-sky-500 transition hover:text-indigo-700"
